    ...
    <section id="how-it-works" ref={sectionRef} className="py-32 relative">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        <div className="text-center mb-20">
          ...
          <h2 className="text-4xl md:text-6xl font-black text-foreground font-heading tracking-tight">How It Works</h2>
        </div>
        ...
        <div className="hidden md:flex items-start justify-between relative">
          ...
          {steps.map((step, i) => (
            ...
            >
              ...
              <h3 className="text-base font-bold text-foreground mb-1 font-heading">{step.title}</h3>
              <p className="text-sm text-muted-foreground leading-relaxed max-w-[160px] font-body">{step.desc}</p>
            </div>
          ))}
        </div>
